        ...
        <footer ref={footerRef} className="py-24 px-6 md:px-12 lg:px-24 bg-black text-white w-full relative z-30 overflow-hidden rounded-t-[3rem] border-t border-gray-900">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800/50">
                <div className="flex gap-8 mb-6 md:mb-0">
                    <a href="https://www.linkedin.com/in/aswani-dubey-7170b7239/" className="text-gray-400 hover:text-white transition-colors interactable text-sm font-semibold uppercase tracking-wider">LinkedIn</a>
                    <a href="https://www.instagram.com/_daswanii_/" className="text-gray-400 hover:text-white transition-colors interactable text-sm font-semibold uppercase tracking-wider">Instagram</a>
                    <a href="https://github.com/ADspecial1" className="text-gray-400 hover:text-white transition-colors interactable text-sm font-semibold uppercase tracking-wider">GitHub</a>
                </div>

                <div className="flex items-center gap-8">
                    <p className="text-gray-500 text-sm">© {new Date().getFullYear()} Aswani. All rights reserved.</p>
